            ...
            <div className="bg-gray-50 rounded-lg p-4 space-y-3">
              <div>
                ...
                <div className="text-sm text-gray-600 ml-5">
                  <div>Inicio: {safeFormatDate(parentTask.startDate)}</div>
                  <div>Fin: {safeFormatDate(parentTask.dueDate)}</div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="text-sm text-gray-600 ml-5">
                  <div>Inicio: {safeFormatDate(subtaskDates.startDate)}</div>
                  <div>Fin: {safeFormatDate(subtaskDates.dueDate)}</div>
                </div>
              </div>
            </div>
          </div>
